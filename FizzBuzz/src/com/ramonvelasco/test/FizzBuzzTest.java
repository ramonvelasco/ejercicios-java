...
public class FizzBuzzTest {
	...
	public void testFizzBuzz() {
		...
		assertEquals("FizzBuzz","1 2 Fizz 4 Buzz Fizz 7 8 Fizz ",fb.calcular(9));
		assertEquals("FizzBuzz","1 2 Fizz 4 Buzz Fizz 7 8 Fizz Buzz 11 ",fb.calcular(11));
		assertEquals("FizzBuzz","1 2 Fizz 4 Buzz Fizz 7 8 Fizz Buzz 11 Fizz ",fb.calcular(12));
		assertEquals("FizzBuzz","1 2 Fizz 4 Buzz Fizz 7 8 Fizz Buzz 11 Fizz 13 ",fb.calcular(13));
		assertEquals("FizzBuzz","1 2 Fizz 4 Buzz Fizz 7 8 Fizz Buzz 11 Fizz 13 14 ",fb.calcular(14));
		assertEquals("FizzBuzz","1 2 Fizz 4 Buzz Fizz 7 8 Fizz Buzz 11 Fizz 13 14 FizzBuzz ",fb.calcular(15));
		assertEquals("FizzBuzz","1 2 Fizz 4 Buzz Fizz 7 8 Fizz Buzz 11 Fizz 13 14 FizzBuzz 16 ",fb.calcular(16));
