...
import com.ramonvelasco.validadores.FizzBuzz;
...
public class FizzBuzzTest {
	...
	public void testFizz() {
		assertTrue("Clase Fizz", fizz.esFizz(3));
		assertFalse("Clase Fizz", fizz.esFizz(4));
		assertFalse("Clase Fizz", fizz.esFizz(5));
		assertTrue("Clase Fizz", fizz.esFizz(6));
		assertTrue("Clase Fizz", fizz.esFizz(9));

	}

	public void testBuzz() {

		assertTrue("Clase Buzz", buzz.esBuzz(5));
		assertFalse("Clase Buzz", buzz.esBuzz(4));
		assertFalse("Clase Buzz", buzz.esBuzz(6));
		assertTrue("Clase Buzz", buzz.esBuzz(15));
		assertTrue("Clase Buzz", buzz.esBuzz(10));
	}
